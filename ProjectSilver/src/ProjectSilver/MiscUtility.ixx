...
export module ProjectSilver.MiscUtility;
...
export namespace Game
{
    ...
    public:
        Trackable() : object(new T), ownsObject(true)
        {
        }

        Trackable(T* target) : object(target), ownsObject(false)
        {
            if (target == nullptr)
            {
                // Nullptr not allowed
        ...
        Trackable(const Trackable<T>& other) : object(nullptr), ownsObject(true)
        {
