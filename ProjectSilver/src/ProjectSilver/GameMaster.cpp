...
namespace Game
{
    ...
    void GameMaster::AddThePlayer()
    {
        ...
        entityMasterList[maxAutoEntityID + SpecialEntities::Player].reset(
            new Actor(new PlayerPseudoAI()));
        Game::Actor& player = *(Actor*)entityMasterList[maxAutoEntityID + SpecialEntities::Player]
                                   .get();
    ...
    void GameMaster::AddTheShadow()
    {
        ...
        entityMasterList[maxAutoEntityID + SpecialEntities::Shadow].reset(
            new Actor(new ShadowAI()));
        Game::Actor& shadow = *(Actor*)entityMasterList[maxAutoEntityID + SpecialEntities::Shadow]
                                   .get();
    ...
    int GameMaster::GetAliveEnemyCount()
    {
        ...
        for (auto& entity : entityMasterList)
        {
            ...
            if (type == EntityType::Fighter || type == EntityType::Knight ||
    ...
    uint64_t GameMaster::CreateAfterImageEffect(const Transform&   parentTransform,
                                                const std::string& texAnimID,
                                                int                frame)
    {
        uint64_t ID = NextEffectID();
...
#pragma warning(pop)
    ...
    void GameMaster::UltimateMegaInitOfDestiny()
    {
        ...
        Assets.LoadSpriteFont("Huge",
                              fontPath + "CourierPrime72_0.png",
                              fontPath + "CourierPrime72.fnt");
        Assets.LoadSpriteFont("Big",
                              fontPath + "CourierPrime48_0.png",
                              fontPath + "CourierPrime48.fnt");
        Assets.LoadSpriteFont("Medium",
                              fontPath + "CourierPrime36_0.png",
                              fontPath + "CourierPrime36.fnt");
        Assets.LoadSpriteFont("Small",
                              fontPath + "CourierPrime24_0.png",
                              fontPath + "CourierPrime24.fnt");
...
#pragma endregion
        ...
        AddAnimation("Player_PistolShoot",
                     Animation("Player_PistolShoot",
                               {{{AnimationCriteria::TriggerAtStart, ""},
                                 {AnimationInstruction::PlaySound, "PlayerShoot"}}}));
        SetAnimationInfo("Player_PistolShoot", {4, 4, 1, LoopMode::PlayOnce});
        SetAnimationCenter("Player_PistolShoot", Vector2(48, 67));

        AddAnimation("Player_PistolReload",
                     Animation("Player_PistolReload",
                               {{{AnimationCriteria::TriggerAtFrameX, "3"},
                                 {AnimationInstruction::PlaySound, "PlayerReload1"}},
                                {{AnimationCriteria::TriggerAtFrameX, "8"},
                                 {AnimationInstruction::PlaySound, "PlayerReload2"}},
                                {{AnimationCriteria::TriggerAtFrameX, "10"},
                                 {AnimationInstruction::PlaySound, "PlayerReload3"}}}));
        SetAnimationInfo("Player_PistolReload", {8, 12, 1, LoopMode::PlayOnce});
        SetAnimationCenter("Player_PistolReload", Vector2(48, 67));

        AddAnimation("Player_RifleShoot",
                     Animation("Player_RifleShoot",
                               {{{AnimationCriteria::TriggerAtStart, ""},
                                 {AnimationInstruction::PlaySound, "PlayerShoot"}}}));
        SetAnimationInfo("Player_RifleShoot", {2, 4, 1, LoopMode::PlayOnce});
        SetAnimationCenter("Player_RifleShoot", Vector2(48, 87));

        AddAnimation("Player_RifleReload",
                     Animation("Player_RifleReload",
                               {{{AnimationCriteria::TriggerAtFrameX, "5"},
                                 {AnimationInstruction::PlaySound, "PlayerReload1"}},
                                {{AnimationCriteria::TriggerAtFrameX, "16"},
                                 {AnimationInstruction::PlaySound, "PlayerReload2"}},
                                {{AnimationCriteria::TriggerAtFrameX, "19"},
                                 {AnimationInstruction::PlaySound, "PlayerReload3"}}}));
        SetAnimationInfo("Player_RifleReload", {5, 21, 1, LoopMode::PlayOnce});
        SetAnimationCenter("Player_RifleReload", Vector2(48, 67));

        AddAnimation("Player_ShieldUp",
                     Animation("Player_ShieldUp",
                               {{{AnimationCriteria::TriggerAtEnd, ""},
                                 {AnimationInstruction::SwitchAnimation,
                                  "Player_ShieldWalk"}}}));
        ...
        AddAnimation("Player_AxeSwing",
                     Animation("Player_AxeSwing",
                               {{{AnimationCriteria::TriggerAtFrameX, "4"},
                                 {AnimationInstruction::PlaySound, "SwordSwing"}}}));
        SetAnimationInfo("Player_AxeSwing", {5, 12, 1, LoopMode::PlayOnce});
        SetAnimationCenter("Player_AxeSwing", Vector2(73, 116));

        AddAnimation("Player_TakeOutRifle",
                     Animation("Player_TakeOutRifle",
                               {{{AnimationCriteria::TriggerAtStart, ""},
                                 {AnimationInstruction::PlaySound, "PlayerReload1"}}}));
        SetAnimationInfo("Player_TakeOutRifle", {4, 5, 1, LoopMode::PlayOnce});
        SetAnimationCenter("Player_TakeOutRifle", Vector2(48, 67));

        AddAnimation("Player_TakeOutPistol",
                     Animation("Player_TakeOutPistol",
                               {{{AnimationCriteria::TriggerAtStart, ""},
                                 {AnimationInstruction::PlaySound, "PlayerReload1"}}}));
        ...
        AddAnimation("Knight_Swing",
                     Animation("Knight_Swing",
                               {{{AnimationCriteria::TriggerAtFrameX, "5"},
                                 {AnimationInstruction::PlaySound, "SwordSwing"}}}));
        ...
        AddAnimation("Berserker_AxeSwing",
                     Animation("Berserker_AxeSwing",
                               {{{AnimationCriteria::TriggerAtFrameX, "4"},
                                 {AnimationInstruction::PlaySound, "SwordSwing"}}}));
        ...
        AddAnimation("GunTurret_Shoot",
                     Animation("GunTurret_Shoot",
                               {{{AnimationCriteria::TriggerAtStart, ""},
                                 {AnimationInstruction::PlaySound, "PlayerShoot"}}}));
        ...
        AddAnimation("Shadow_AxeSwing",
                     Animation("Shadow_AxeSwing",
                               {{{AnimationCriteria::TriggerAtFrameX, "4"},
                                 {AnimationInstruction::PlaySound, "SwordSwing"}}}));
        ...
        AddAnimation("Shadow_PistolShoot",
                     Animation("Shadow_PistolShoot",
                               {{{AnimationCriteria::TriggerAtStart, ""},
                                 {AnimationInstruction::PlaySound, "PlayerShoot"}}}));
        ...
        AddAnimation("Shadow_TakeOutPistol",
                     Animation("Shadow_TakeOutPistol",
                               {{{AnimationCriteria::TriggerAtStart, ""},
                                 {AnimationInstruction::PlaySound, "PlayerReload1"}}}));
        SetAnimationInfo("Shadow_TakeOutPistol", {4, 5, 1, LoopMode::PlayOnce});
        SetAnimationCenter("Shadow_TakeOutPistol", Vector2(48, 67));

        AddAnimation("Shadow_PutAwayPistol",
                     Animation("Shadow_PutAwayPistol",
                               {{{AnimationCriteria::TriggerAtStart, ""},
                                 {AnimationInstruction::PlaySound, "PlayerReload1"}}}));
        SetAnimationInfo("Shadow_PutAwayPistol", {4, 5, 1, LoopMode::PlayOnce});
        SetAnimationCenter("Shadow_PutAwayPistol", Vector2(48, 67));

        AddAnimation("Shadow_RecoveryStart",
                     Animation("Shadow_RecoveryStart",
                               {{{AnimationCriteria::TriggerAtFrameX, "5"},
                                 {AnimationInstruction::PlaySound, "PlayerDeath"}}}));
    ...
    {
        if (entityMasterList.find(maxAutoEntityID + SpecialEntities::TheLevelDirector) !=
            entityMasterList.end())
        {
            return;
        }
        entityMasterList[maxAutoEntityID + SpecialEntities::TheLevelDirector].reset(
            new LevelDirector());
    ...
    {
        if (entityMasterList.find(maxAutoEntityID + SpecialEntities::TheMenuDirector) !=
            entityMasterList.end())
        {
            return;
        }
        entityMasterList[maxAutoEntityID + SpecialEntities::TheMenuDirector].reset(
            new MenuDirector());
        ...
        for (auto firstIt = colliderLibrary.begin(); firstIt != libEnd; firstIt++)
        {
            ...
            for (Collider* beta : candidates)
            {
                ...
                if ((alpha->GetColliderType() == CType::Static ||
                     alpha->GetColliderType() == CType::CombatStatic) &&
                    (beta->GetColliderType() == CType::Static ||
                     beta->GetColliderType() == CType::CombatStatic))
                {
                    continue;
                }
    ...
    void GameMaster::ResolveCombatCollisions()
    {
        ...
        for (auto firstIt = colliderLibrary.begin(); firstIt != colliderLibrary.end();
             firstIt++)
        {
            Collider* alpha = firstIt->second;
            // Discard anything which isn't a combat collider
            if (!(alpha->GetColliderType() == CType::Combat ||
                  alpha->GetColliderType() == CType::CombatDynamic ||
                  alpha->GetColliderType() == CType::CombatStatic))
            {
                continue;
            }
            ...
            for (Collider* beta : candidates)
            {
                ...
                if (collidedPairs.find({alpha, beta}) != collidedPairs.end() ||
                    collidedPairs.find({beta, alpha}) != collidedPairs.end())
                {
                    continue;
                }
                ...
                // Discard anything which isn't a combat collider
                if (!(beta->GetColliderType() == CType::Combat ||
                      beta->GetColliderType() == CType::CombatDynamic ||
                      beta->GetColliderType() == CType::CombatStatic))
                {
                    continue;
                }
                ...
                if (result.first)
                {
                    ...
                    if (alpha->GetCollisionOptions().find(
                            Collider::CollisionOptions::DoNotHitRememberedEntities) !=
                        alpha->GetCollisionOptions().end())
                    {
                    ...
                    if (beta->GetCollisionOptions().find(
                            Collider::CollisionOptions::DoNotHitRememberedEntities) !=
                        beta->GetCollisionOptions().end())
                    {
                    ...
                    if (HurtA)
                    {
                        if (EntityA != nullptr && EntityA->GetAI() != nullptr)
                            EntityA->GetAI()->OnHitByAttack(EntityB, beta->GetCombatDamage());
                        if (EntityB != nullptr && EntityB->GetAI() != nullptr)
                            EntityB->GetAI()->OnAttackHit();
                    ...
                    {
                        if (EntityB != nullptr && EntityB->GetAI() != nullptr)
                            EntityB->GetAI()->OnHitByAttack(EntityA, alpha->GetCombatDamage());
                        if (EntityA != nullptr && EntityA->GetAI() != nullptr)
                            EntityA->GetAI()->OnAttackHit();
                        //std::cout << "HurtB ";
                    }
    ...
    std::vector<std::pair<double, Collider*>> GameMaster::CreateRayCastHitList(
        const Vector2& A,
        const Vector2& B)
    {
