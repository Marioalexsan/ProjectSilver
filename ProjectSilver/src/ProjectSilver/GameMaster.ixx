...
export module ProjectSilver.GameMaster;
...
import ProjectSilver.InputHandler;
...
export namespace Game
{
    ...
    public:
        ...
        inline void SetRenderDisableCounter(int count)
        {
            renderDisableCounter = count;
        }

        inline void SetDifficulty(DifficultyLevel difficulty)
        {
            this->difficulty = difficulty;
        }

        inline DifficultyLevel GetDifficulty()
        {
        ...
        uint64_t CreateAfterImageEffect(const Transform&   parentTransform,
        ...
        std::vector<std::pair<double, Collider*>> CreateRayCastHitList(const Vector2& A,
                                                                       const Vector2& B);
    };
} // namespace Game
